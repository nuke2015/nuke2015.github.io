...
set ROOT_PATH=%CD%
set JAVA_HOME=%ROOT_PATH%\Java\jdk1.8.0_20
...
setx path  %MINGW%\bin;%GOROOT%\bin;%GIT_HOME%\bin;%NODE_HOME%;%NODE_HOME%\node_modules\.bin;%ANT_HOME%\bin;%ANDROID_SDK%\tools;%ANDROID_SDK%\platform-tools;%JAVA_HOME%\bin;%MAVEN_HOME%\bin;%path%;%PHPROOT%;
pause
