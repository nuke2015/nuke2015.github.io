@echo Restore The Service Start State Saved At 15:15:07.64 2016/03/20 ÷‹»’  
@pause 
sc config   2345PinyinSvc start= DISABLED 
...
sc config   BBService start= AUTO 
...
sc config   Protect_2345Explorer start= DISABLED 
...
sc config   TxQBService start= AUTO 
