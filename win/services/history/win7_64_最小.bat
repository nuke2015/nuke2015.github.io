@echo Restore The Service Start State by fengfeng  
@pause
sc config   AdobeFlashPlayerUpdateSvc start= DISABLED  
sc config   2345MobileService start= DISABLED 
sc config   2345Safe start= DISABLED 
...
sc config   KuaizipUpdateChecker start= DISABLED 
@pause 
