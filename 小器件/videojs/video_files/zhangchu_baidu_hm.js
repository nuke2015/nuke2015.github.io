(function() {
    var h = {},
        mt = {},
        c = {
            id: "078933d0bb9bf6d161f875dd8c0b1ac2",
            dm: ["h5.izhangchu.com"],
    ...
    var r = void 0,
        ...
        w = !1;
    mt.i = {};
    mt.i.T = /msie (\d+\.\d+)/i.test(navigator.userAgent);
    mt.i.ua = /msie (\d+\.\d+)/i.test(navigator.userAgent) ? document.documentMode || +RegExp.$1 : r;
    ...
    mt.i.Aa = (window.screen.width || 0) + "x" + (window.screen.height || 0);
        ...
        return function(d) {
            switch (typeof d) {
                ...
                default:
                    ...
                    g = mt.l.stringify;
                    for (f in d)
                        if (Object.prototype.hasOwnProperty.call(d, f)) switch (k = d[f], typeof k) {
                            case "undefined":
                            case "unknown":
                            case "function":
                                break;
    ...
    (function() {
        var a = mt.lang,
            ...
            d = {
                va: function(e) {
                    if ((window._dxt === r || a.e(window._dxt, "Array")) && "undefined" !== typeof h.b) {
                        var d = h.b.I();
    ...
    (function() {
        ...
        var f = mt.lang,
            ...
            g = {
                ...
                fa: function() {
                    if (0 < g.r.length)
                        for (var a = 0, b = g.r.length; a < b; a++) g.M(g.r[a]);
                    g.r = t
                },
                M: function(a) {
                    var b = a[0];
                ...
                _setAutoPageview: function(a) {
                    if (1 < a.length && (a = a[1], w === a || s === a)) g.d |= 2, h.b.S = a
                },
                ...
                _trackRTEvent: function(b) {
                    ...
                    if (f.e(b, "Object")) {
                        ...
                        if (900 >= m) l.call(this, b);
                            ...
                            for (var m = Math.ceil(m / 900), p = "block|" + Math.round(Math.random() * e.L).toString(16) + "|" + m + "|", q = [], u = 0; u < m; u++) q.push(u), q.push(b.substring(900 * u, 900 * u + 900)), l.call(this, p + q.join("|")), q = []
                    }
                },
    ...
    (function() {
        ...
        a.prototype = {
            ...
            Ga: function() {
                ...
                this.a.ci = b.k(a, l.oa) || "";
                this.a.cf = b.k(a, l.ta) || "";
                this.a.cu = b.k(a, l.pa) || ""
            },
            init: function() {
                try {
                    this.Ga(), 0 === this.a.nv ? this.Ca() : this.N(".*"), h.b = this, this.ba(), v.z("pv-b"), this.Ba()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
            ...
            Ba: function() {
                ...
                this.S ? (this.J = s, this.a.et = 0, this.a.ep = "", this.j(a)) : a()
            },
            j: function(a) {
                var b = this;
                b.a.rnd = Math.round(Math.random() * l.L);
                v.z("stag-b");
                var d = l.protocol + "//" + l.X + "?" + b.Da();
                v.z("stag-d");
                b.Z(d);
                f.log(d, function(d) {
                    b.N(d);
    ...
    (function() {
        var a = mt.i,
            ...
            f = mt.event,
            d = mt.l;
        if ("undefined" !== typeof h.b && (c.med || (!a.T || 7 < a.ua) && c.cvcc)) {
                ...
                v = function(a, f) {
                    ...
                    if (f) {
                        var m = f.getAttribute("href"),
                            ...
                            l = f.getAttribute("id") || "";
                        n.test(m) ? (g.sn = "mediate", g.snv = m) : b.e(k, "String") && n.test(k) && (g.sn = "wrap", g.snv = k);
                        g.id = l
                    }
                    h.b.a.et = 86;
                    h.b.a.ep = d.stringify(g);
            ...
            if (c.med) m = "/zoosnet", e = "swt", n = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, g = {
                ...
                g = {
                    click: function() {
                        for (var a = [], b = k(document.getElementsByTagName("a")), b = [].concat.apply(b, k(document.getElementsByTagName("area"))), b = [].concat.apply(b, k(document.getElementsByTagName("img"))), d, e, f, g = 0, m = b.length; g < m; g++) d = b[g], n !== r ? (e = d.getAttribute("onclick"), f = d.getAttribute("href"), p ? (d = d.getAttribute("id"), (n.test(e) || n.test(f) || p.test(d)) && a.push(b[g])) : (n.test(e) || n.test(f)) && a.push(b[g])) : p !== r && (d = d.getAttribute("id"), p.test(d) && a.push(b[g]));
                        return a
                    }
                }
            }
            if ("undefined" !== typeof g && "undefined" !== typeof n) {
                ...
                f.c(document, "mousedown", function(a) {
                    ...
                    for (l(g, function(a, e) {
                            d[a] = b.e(e, "Function") ? e() : document.getElementById(e)
    ...
    (function() {
        ...
        a.prototype = {
            ...
            xa: function() {
                var a = this;
                this.ga(function(d) {
                    d !== r && "" !== d && (b.log("//datax.baidu.com/x.gif?dm=" + encodeURIComponent("datax.baidu.com/webadapter/guid") + "&ac=" + encodeURIComponent(d) + "&v=hm-webadapter-0.0.1&rnd=" + Math.round(2147483647 * Math.random())), a.Ea("hmKey", +new Date, function() {
                        a.Ia()
                    }))
                })
            }
        ...
        if (f.T && /^http(s)?:$/.test(document.location.protocol)) {
            var d = new a;
            d.wa(function(a) {
                0 === a && d.ka("hmKey", function(a) {
                    a = +a;
                    (isNaN(a) || 6048E5 < +new Date - a) && d.xa()
                })
            })
        }
    })();
