var api = {
    ...
    dropdown: function(el, skiller_id) {
        console.log(el, skiller_id);
        ...
        dropdown.render({
            ...
            data: [{
                title: "基础信息",
                act_id: 0,
                href: "/html/skiller_info.html?skiller_id=" + skiller_id,
            }, {
                title: "头像与证书",
                act_id: 0,
                href: "/html/skiller_info_ava.html?skiller_id=" + skiller_id,
            }, {
                title: "联系方式",
                act_id: 0,
                href: "/html/skiller_contact_info.html?skiller_id=" + skiller_id,
            }, {
                title: "添加评价",
                act_id: 0,
                href: "/html/comment_info.html?skiller_id=" + skiller_id,
            }, {
                title: "锁定档期",
                act_id: 0,
                href: "/html/schedule_info.html?skiller_id=" + skiller_id,
            }, {
                title: "请假",
                act_id: 0,
                href: "/html/vacation_info.html?skiller_id=" + skiller_id,
            }, {
                title: "标签设置",
                act_id: 0,
                href: "/html/skiller_list_200.html?skiller_id=" + skiller_id,
            }, {
                title: "证书勾选",
                act_id: 0,
                href: "/html/skiller_cert_200.html?skiller_id=" + skiller_id,
            }, {
                title: "上下线",
                act_id: 666,
                href: "#",
            ...
            click: function(obj) {
                ...
                if (act_id == 666) {
                    var status = el.attr("data-online_status");
                    if (status > 0) {
                        status = 0;
                    } else {
                        status = 1;
...
// api.config_get();
api.req.page = 1;
api.req.skiller_id = g_params.skiller_id;
api.DemoList();
//时间范围
