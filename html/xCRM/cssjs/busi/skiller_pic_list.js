var api = {
    ...
    table_config: function () {
        return [
            [{
                ...
                width: 200,
                templet: function (d) {
                    return '<img src="'+d.pic+'" class="img_min" />';
                },
            }, {
                field: "create_at",
                title: "上传时间",
    ...
    table_bind: function () {
        ...
        $(".js_edit").click(function() {
            var id = $(this).attr('data-id');
            var turl="/html/skiller_pic_info.html?id="+id;
            fengform.open(turl);
        });
    },
...
layui.jquery("#demo_add").click(function () {
    var turl= "/html/skiller_pic_info.html?skiller_id="+skiller_id;
    fengform.open(turl);
});
// 滑动门
$("#tab_switch>li").click(function (k, v) {
    api.req.type_pic = $(this).attr("data-type_pic");
    api.DemoList();
});
