...
var helper = {
    ...
    zhaosheng_url: function() {
        return helper.getConfigWebInfo().awt_zhanshen + encodeURIComponent(location.href) + '&r=' + encodeURIComponent(document.referrer);
    },
    // 紫月皇后商务通
    ziyue_url: function() {
        return "https://plt.zoosnet.net/LR/Chatpre.aspx?id=PLT19296989&cid=1505904402033524900782&lng=cn&sid=1505904402033524900782&p=" + encodeURIComponent(location.href) + '&rf1=' + encodeURIComponent(document.referrer) + '&rf2=&msg=&d=' + new Date().getTime();
    },
    //live800的关键词统计
    ga_live800: function() {
        var _gaq = _gaq || [];
        _gaq.push(['_setAccount', 'UA-40698071-2']);
        _gaq.push(['_trackPageview']);
        var ga = document.createElement('script');
        ga.type = 'text/javascript';
        ga.async = true;
        ga.src = '/a/Url/live800_ga';
    ...
    // 登陆回跳
    gotoLogin: function() {
        location.href = '//' + TQ._domains.main + '/html/login.html?from=' + encodeURIComponent(location.href);
    },
    // 自由跳转
    ...
    timeStampToDate: function(seconds, f) {
        ...
        if (f == 'day') {
            ...
            return md.getFullYear() + "-" + (md.getMonth() + 1) + "-" + md.getDate() + " " + hour + ":" + minutes + ":" + snd;
        } else {
            return md.getFullYear() + "/" + (md.getMonth() + 1) + "/" + md.getDate() + " " + hour + ":" + minutes + ":" + snd;
        }
    },
